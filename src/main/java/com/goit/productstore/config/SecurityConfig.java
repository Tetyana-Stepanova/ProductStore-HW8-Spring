package com.goit.productstore.config;

import com.goit.productstore.models.auth.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/manufacturer").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN")
                .antMatchers("/product").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN")
                .antMatchers("/user").hasAuthority("ROLE_ADMIN")
                .antMatchers("/createManufacturer").hasAuthority("ROLE_ADMIN")
